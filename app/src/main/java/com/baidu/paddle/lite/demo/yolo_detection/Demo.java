...
public class Demo extends Activity implements View.OnClickListener, CameraSurfaceView.OnTextureChangedListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_shutter:
                ...
                Toast.makeText(Demo.this, "Save snapshot to " + savedImagePath, Toast.LENGTH_SHORT).show();
                break;
            case R.id.btn_settings:
                startActivity(new Intent(Demo.this, SettingsActivity.class));
                break;
        }
    }
